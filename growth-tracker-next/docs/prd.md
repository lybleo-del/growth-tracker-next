...
4. **个人页 (Profile)**: 用户信息、主题切换、更新日志、云端同步
...
| 专注页 | 番茄钟计时器 | 大数字显示倒计时，进度环动画，开始/暂停/重置控制，支持自定义专注/休息时长，开始计时后锁定设置 |
| 专注页 | 白噪音 | 雨声、咖啡馆、白噪音、粉红噪音、森林音效，使用Web Audio API合成生成，无需外部音频文件，支持音量调节 |
| 个人页 | 主题切换 | 支持日间（浅色）和夜间（深色）模式切换，设置保存到本地存储 |
| 个人页 | 云端同步 | 支持Supabase云端数据库同步，解决重新部署后数据丢失问题，支持开关控制 |
| 个人页 | 更新日志 | 可折叠面板展示版本历史记录，包含版本号、日期和更新内容 |
